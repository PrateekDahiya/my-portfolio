...
const Projects = () => {
    const projectDetails = [
        {
            ...
            links: [
                { text: "Check out platform here: VidVault", url: "https://canvas-fulcrum-386304.web.app/" },
                { text: "GitHub: Frontend", url: "https://github.com/PrateekDahiya/YouTube-Clone" },
                { text: "GitHub: Node Server", url: "https://github.com/PrateekDahiya/Youtube-clone-server" },
                { text: "GitHub: Flask Server", url: "https://github.com/PrateekDahiya/Flaskapp" }
            ]
        },
        {
            title: "LingoVerse",
            ...
            links: [
                { text: "Check out the platform here: LingoVerse", url: "https://lingoverse-37674.web.app/" },
                { text: "GitHub: LingoVerse GitHub", url: "https://github.com/PrateekDahiya/LanguageLearning" }
            ]
        },
        {
        ...
        },
        {
            ...
            links: [{ text: "Check out Game here", url: "https://dahiya-prtk27.itch.io/pacman-clone" }
            ]
        },
        {
            ...
            links: [
                { text: "Check out device here", url: "https://www.tinkercad.com/things/7rnUvI87Rk0-automatic-garage-opener" }
            ]
        }
    ];
    ...
    useEffect(() => {
        if (showModal) {
            ...
            console.log('Modal closed (effect), setting body overflow to unset');
        }
    ...
    return (
        <section id="Projects" className="section animation">
            <div className="section-body">
                <h2 className="section-title animation-translate animation-item-1">Projects</h2>
                <div className="row project-box animation-translate animation-item-2">
                    {projectDetails.map((project, index) => (
                        <div key={index} className="col-12 col-md-4 project-grid-item" onClick={() => openModal(project)}>
                            <img src={`/assets/img/${project.image}`} alt={project.title} className="img-fluid project-image" />
